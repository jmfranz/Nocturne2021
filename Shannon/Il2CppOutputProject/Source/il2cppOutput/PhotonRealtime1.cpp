...
IL_001a:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_6 = ___propertiesToCache0;
		NullCheck(L_6);
		bool L_7;
		L_7 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_6, (uint8_t)((int32_t)251), /*hidden argument*/NULL);
		if (!L_7)
		{
			goto IL_0046;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_8 = ___propertiesToCache0;
		NullCheck(L_8);
		RuntimeObject * L_9;
		L_9 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_8, (uint8_t)((int32_t)251), /*hidden argument*/NULL);
...
IL_0046:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_11 = ___propertiesToCache0;
		NullCheck(L_11);
		bool L_12;
		L_12 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_11, (uint8_t)((int32_t)255), /*hidden argument*/NULL);
		if (!L_12)
		{
			goto IL_0069;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_13 = ___propertiesToCache0;
		NullCheck(L_13);
		RuntimeObject * L_14;
		L_14 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_13, (uint8_t)((int32_t)255), /*hidden argument*/NULL);
...
IL_0069:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_15 = ___propertiesToCache0;
		NullCheck(L_15);
		bool L_16;
		L_16 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_15, (uint8_t)((int32_t)253), /*hidden argument*/NULL);
		if (!L_16)
		{
			goto IL_008c;
		}
	}
	{
		...
		NullCheck(L_17);
		RuntimeObject * L_18;
		L_18 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_17, (uint8_t)((int32_t)253), /*hidden argument*/NULL);
...
IL_008c:
	{
		...
		NullCheck(L_19);
		bool L_20;
		L_20 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_19, (uint8_t)((int32_t)254), /*hidden argument*/NULL);
		if (!L_20)
		{
			goto IL_00af;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_21 = ___propertiesToCache0;
		NullCheck(L_21);
		RuntimeObject * L_22;
		L_22 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_21, (uint8_t)((int32_t)254), /*hidden argument*/NULL);
...
IL_00af:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_23 = ___propertiesToCache0;
		NullCheck(L_23);
		bool L_24;
		L_24 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_23, (uint8_t)((int32_t)252), /*hidden argument*/NULL);
		if (!L_24)
		{
			goto IL_00d2;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_25 = ___propertiesToCache0;
		NullCheck(L_25);
		RuntimeObject * L_26;
		L_26 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_25, (uint8_t)((int32_t)252), /*hidden argument*/NULL);
...
IL_00d2:
	{
		...
		NullCheck(L_27);
		bool L_28;
		L_28 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_27, (uint8_t)((int32_t)249), /*hidden argument*/NULL);
		if (!L_28)
		{
			goto IL_00f5;
		}
	}
	{
		...
		NullCheck(L_29);
		RuntimeObject * L_30;
		L_30 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_29, (uint8_t)((int32_t)249), /*hidden argument*/NULL);
...
IL_00f5:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_31 = ___propertiesToCache0;
		NullCheck(L_31);
		bool L_32;
		L_32 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_31, (uint8_t)((int32_t)248), /*hidden argument*/NULL);
		if (!L_32)
		{
			goto IL_0118;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_33 = ___propertiesToCache0;
		NullCheck(L_33);
		RuntimeObject * L_34;
		L_34 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_33, (uint8_t)((int32_t)248), /*hidden argument*/NULL);
...
IL_0118:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_35 = ___propertiesToCache0;
		NullCheck(L_35);
		bool L_36;
		L_36 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_35, (uint8_t)((int32_t)250), /*hidden argument*/NULL);
		if (!L_36)
		{
			goto IL_013b;
		}
	}
	{
		...
		NullCheck(L_37);
		RuntimeObject * L_38;
		L_38 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_37, (uint8_t)((int32_t)250), /*hidden argument*/NULL);
...
IL_013b:
	{
		...
		NullCheck(L_39);
		bool L_40;
		L_40 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_39, (uint8_t)((int32_t)247), /*hidden argument*/NULL);
		if (!L_40)
		{
			goto IL_015e;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_41 = ___propertiesToCache0;
		NullCheck(L_41);
		RuntimeObject * L_42;
		L_42 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_41, (uint8_t)((int32_t)247), /*hidden argument*/NULL);
...
IL_015e:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_43 = ___propertiesToCache0;
		NullCheck(L_43);
		bool L_44;
		L_44 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_43, (uint8_t)((int32_t)245), /*hidden argument*/NULL);
		if (!L_44)
		{
			goto IL_0181;
		}
	}
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_45 = ___propertiesToCache0;
		NullCheck(L_45);
		RuntimeObject * L_46;
		L_46 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_45, (uint8_t)((int32_t)245), /*hidden argument*/NULL);
...
IL_0181:
	{
		...
		NullCheck(L_47);
		bool L_48;
		L_48 = Hashtable_ContainsKey_m9CB2F369C145A781E745542D3C2A7AAD2B95C457(L_47, (uint8_t)((int32_t)246), /*hidden argument*/NULL);
		if (!L_48)
		{
			goto IL_01a4;
		}
	}
	{
		...
		NullCheck(L_49);
		RuntimeObject * L_50;
		L_50 = Hashtable_get_Item_mE7368935B83FAD465E25F880BF773393C57D8F20(L_49, (uint8_t)((int32_t)246), /*hidden argument*/NULL);
...
IL_01a4:
	{
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_51 = __this->get_customProperties_1();
		...
		Hashtable_t43276794A006CD84952AFAB156E51DD9D331596D * L_53 = __this->get_customProperties_1();
		Extensions_StripKeysWithNullValues_m8F8740F4F2091C5AB114AD575C28B6A90180765B(L_53, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SupportLogger_TrackValues_m70D4240C8A119A9F6A260E068D85D146DFFD6380 (SupportLogger_t5DDB4975F6F861A267161FAD7E364707CFC0A002 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_2);
		int32_t L_3;
		L_3 = PhotonPeer_get_RoundTripTime_m59472820E0C4B43735EAFCB760F7FA8AD2D2D125(L_2, /*hidden argument*/NULL);
		V_0 = L_3;
...
IL_0016:
	...
	}
	{
		...
		NullCheck(L_10);
		String_t* L_11;
		L_11 = PhotonPeer_VitalStatsToString_m46687C2E5975ED699DD056A1A47DF5FCECF5AD68(L_10, (bool)0, /*hidden argument*/NULL);
		NullCheck(L_8);
...
IL_00a1:
	{
		...
		String_t* L_34;
		L_34 = PhotonPeer_get_Version_m8D829DEFFBD0E4677A535F35570467DC4EFF93D3(/*hidden argument*/NULL);
		NullCheck(L_33);
		...
		NullCheck(L_41);
		int32_t L_42 = ((PhotonPeer_tA9416F27EB935317E1AFD34031CEA28BF957CADD *)L_41)->get_TargetFramework_8();
		int32_t L_43 = L_42;
		RuntimeObject * L_44 = Box(TargetFrameworks_tFB9EC18927F8361341260A59B592FAA8EB50177D_il2cpp_TypeInfo_var, &L_43);
		NullCheck(L_39);
	...
	}
	{
		...
		NullCheck(L_50);
		Type_t * L_51;
		L_51 = PhotonPeer_get_SocketImplementation_mAC4A1FC38B0992934D9EB4FC6EC12021D2C07602_inline(L_50, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_55);
		Type_t * L_56;
		L_56 = PhotonPeer_get_SocketImplementation_mAC4A1FC38B0992934D9EB4FC6EC12021D2C07602_inline(L_55, /*hidden argument*/NULL);
		NullCheck(L_56);
		String_t* L_57;
...
IL_01a8:
	{
		...
		NullCheck(L_91);
		String_t* L_92;
		L_92 = PhotonPeer_get_PeerID_m7FAAED9A600AF34CB1133618EA2320D6C13A70AA(L_91, /*hidden argument*/NULL);
		NullCheck(L_89);
		...
		NullCheck(L_104);
		String_t* L_105;
		L_105 = PhotonPeer_get_ServerIpAddress_m857E470756B99A4D899DE362F2250BC9F862E012(L_104, /*hidden argument*/NULL);
		NullCheck(L_102);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SupportLogger_OnConnected_m84F8E9098FB782DCC7618BF8366F14E27722A215 (SupportLogger_t5DDB4975F6F861A267161FAD7E364707CFC0A002 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_7);
		PhotonPeer_set_TrafficStatsEnabled_m65B5C7C4FF0584A247331109F716AAA5B54D97A5(L_7, (bool)0, /*hidden argument*/NULL);
		...
		NullCheck(L_9);
		PhotonPeer_set_TrafficStatsEnabled_m65B5C7C4FF0584A247331109F716AAA5B54D97A5(L_9, (bool)1, /*hidden argument*/NULL);
		// this.StartLogStats();
...
IL_0014:
		{
			...
			OperationResponse_t9F45DBD05141C2572E1B7C2BB11FCC67539B2339 * L_3 = ___response0;
			NullCheck(L_2);
			InterfaceActionInvoker1< OperationResponse_t9F45DBD05141C2572E1B7C2BB11FCC67539B2339 * >::Invoke(0 /* System.Void Photon.Realtime.IWebRpcCallback::OnWebRpcResponse(ExitGames.Client.Photon.OperationResponse) */, IWebRpcCallback_t88753C6C07891FBB7208902706B417D185B0B910_il2cpp_TypeInfo_var, L_2, L_3);
		}
...
IL_0026:
	{
		...
		NullCheck(L_4);
		ParameterDictionary_tB15EFEE2CDF94EA8CCB2E555C303C2E9B881FC48 * L_5 = L_4->get_Parameters_3();
		NullCheck(L_5);
		bool L_6;
		L_6 = ParameterDictionary_TryGetValue_m3F893EE5C028930D623430DCBB5505D539A3C0CA(L_5, (uint8_t)((int32_t)207), (RuntimeObject **)(&V_0), /*hidden argument*/NULL);
		if (!L_6)
		{
			goto IL_004d;
		}
...
IL_004d:
	{
		...
		OperationResponse_t9F45DBD05141C2572E1B7C2BB11FCC67539B2339 * L_8 = ___response0;
		NullCheck(L_8);
		ParameterDictionary_tB15EFEE2CDF94EA8CCB2E555C303C2E9B881FC48 * L_9 = L_8->get_Parameters_3();
		NullCheck(L_9);
		bool L_10;
		L_10 = ParameterDictionary_TryGetValue_m3F893EE5C028930D623430DCBB5505D539A3C0CA(L_9, (uint8_t)((int32_t)208), (RuntimeObject **)(&V_0), /*hidden argument*/NULL);
		if (!L_10)
		{
			goto IL_006d;
		}
...
IL_006d:
	{
		...
		OperationResponse_t9F45DBD05141C2572E1B7C2BB11FCC67539B2339 * L_12 = ___response0;
		NullCheck(L_12);
		ParameterDictionary_tB15EFEE2CDF94EA8CCB2E555C303C2E9B881FC48 * L_13 = L_12->get_Parameters_3();
		NullCheck(L_13);
		bool L_14;
		L_14 = ParameterDictionary_TryGetValue_m3F893EE5C028930D623430DCBB5505D539A3C0CA(L_13, (uint8_t)((int32_t)206), (RuntimeObject **)(&V_0), /*hidden argument*/NULL);
		if (!L_14)
		{
			goto IL_008d;
		}
