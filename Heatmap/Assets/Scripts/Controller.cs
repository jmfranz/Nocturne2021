...
public class Controller : MonoBehaviour {
    ...
    public void Seek() {
        ...
        viewCamera.localPosition = Vector3.Lerp(positions[i - 1], positions[i], lerp);
        viewCamera.localRotation = Quaternion.Lerp(rotations[i - 1], rotations[i], lerp);
        userIDText.text = "User ID\t: " + id;
        posXText.text = "Pos X\t\t: " + viewCamera.localPosition.x.ToString("0.00");
        posYText.text = "Pos Y\t\t: " + viewCamera.localPosition.y.ToString("0.00");
        posZText.text = "Pos Z\t\t: " + viewCamera.localPosition.z.ToString("0.00");
        rotXText.text = "Rot X\t\t: " + viewCamera.localRotation.x.ToString("0.00");
        rotYText.text = "Rot Y\t\t: " + viewCamera.localRotation.y.ToString("0.00");
        rotZText.text = "Rot Z\t\t: " + viewCamera.localRotation.z.ToString("0.00");
        rotWText.text = "Rot W\t\t: " + viewCamera.localRotation.w.ToString("0.00");
    ...
    public void Seek2()
    {
        ...
        viewCamera2.localPosition = Vector3.Lerp(positions2[i - 1], positions2[i], lerp);
        viewCamera2.localRotation = Quaternion.Lerp(rotations2[i - 1], rotations2[i], lerp);
        userIDText2.text = "User ID\t: " + id2;
        posXText2.text = "Pos X\t\t: " + viewCamera2.localPosition.x.ToString("0.00");
        posYText2.text = "Pos Y\t\t: " + viewCamera2.localPosition.y.ToString("0.00");
        posZText2.text = "Pos Z\t\t: " + viewCamera2.localPosition.z.ToString("0.00");
        rotXText2.text = "Rot X\t\t: " + viewCamera2.localRotation.x.ToString("0.00");
        rotYText2.text = "Rot Y\t\t: " + viewCamera2.localRotation.y.ToString("0.00");
        rotZText2.text = "Rot Z\t\t: " + viewCamera2.localRotation.z.ToString("0.00");
        rotWText2.text = "Rot W\t\t: " + viewCamera2.localRotation.w.ToString("0.00");
