...
{
    /// <summary>
    /// <c>ORRule</c> tests any two <c>Rules</c> with an OR (One <c>Rules</c>
    /// must be true in order to the <c>ORRule</c> to pass.
    /// </summary>
    public class ORRule : CompoundRules
    {
        /// <summary>
        /// <c>OREvent</c> is defind as public event and is listed within the rule 
        ...
        public ORRule(Rules FirstRule, Rules SecondRule)
        {
        ...
        /// <summary>
        /// <c>test</c> method is used to check if the rule is valid and call <c>OnOREvent</c>
        /// upon rule validation to fire <c>OREvent</c>
        /// </summary>
        ...
        /// <summary>
        /// <c>OnOREvent</c> method is called to raise <c>OREvent</c> if the rule is valid
        /// </summary>
